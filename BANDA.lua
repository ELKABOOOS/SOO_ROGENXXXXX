...
if not DevSoFi(msg) then
local Text = [[
سعر النتصيب علي سورس روجين
اول شهر علي روجين مجانا وكل شهر 25ج 
لو حابب تنصب بوتك اتبع مبرمجين السورس❤️.
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
if not DevSoFi(msg) then
local Text = [[
سعر السورس عند مارتن والكابوس مجانا
لوحابب تعمل سورس بكل الحقوق اتبع المبرمجين❤️.
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𝚞𝚜𝚎𝚛𝚜 𝚛𝚘𝚐𝚎𝚗', url="t.me/US_ROGEN"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
if text == 'المبرمج كابوس' and DevSoFi(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
...
if text == 'المبرمج مارتن' and DevSoFi(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
...
if text == 'كابوس' or text == 'الكابوس' or text == 'محمد' then
local Text = [[
الكابوس مبرمج سورس روجين لوحابب تتواصل معاه ❤️.
...
if text == 'كريم' or text == 'الماجيك' or text == 'كريم الماجيك' then
local Text = [[
...
if text == 'مارتن' or text == 'مارتن التونز' or text == 'الهقر' then
local Text = [[
مارتن مبرمج سورس روجين لوحابب تتواصل معاه ❤️.
...
send(msg.chat_id_,msg.id_, '[نت مطوري تاج راسي 😊❤️.](t.me/SO_ROGEN)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مطوري الثاني حته مني 😍❤️.](t.me/SO_ROGEN)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت هنا منشئ اساسي يعني اعلى رتبه عاوزك تفتخر😂❤️](t.me/SO_ROGEN)')
return false
end
...
send(msg.chat_id_,msg.id_, '[باي..😩❤️](t.me/SO_ROGEN)')
return false
end
...
send(msg.chat_id_,msg.id_, '[البوت شغال](t.me/SO_ROGEN)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[مين محترام ناو 😂😂](t.me/SO_ROGEN)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[لا انا شغل متحوارش يهقر 😂😂](t.me/SO_ROGEN)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[ونكمن بعشق امك 😹❤](t.me/SO_ROGEN)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[هتخدها فين يواد 😹❤](t.me/SO_ROGEN)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[مش بدودو ..😹❤️](t.me/SO_ROGEN)')
return false
end
end
end
...
send(msg.chat_id_, msg.id_,' ✧ انت دخلت عبر الرابط يوسخ 🌝❤️') 
end
end,nil)
else
...
{{text = 'القائمه الرائسيه', callback_data="/add"}},
{{text = '𝚜𝚘𝚞𝚛𝚌𝚎 𝚛𝚘𝚘𝚐𝚎𝚗', url="t.me/ch_nasa"}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
if Text == '/sofi' then
